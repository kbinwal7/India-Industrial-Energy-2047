...
Links sectoral GDP growth with projected energy efficiency improvements (AEEI-based modelling).

• Activity–Intensity Model
Forecasts demand using sector-specific production growth rates and intensity reduction trends.

• Scenario & Sensitivity Analysis
Best, baseline, and worst-case projections based on variations in growth and efficiency assumptions.
...
- Total industrial energy demand could range between ~400–1,450 Mtoe by 2047 depending on growth trajectories.

- Solar and wind emerge as major contributors, but low capacity factors require significant installed capacity expansion.
